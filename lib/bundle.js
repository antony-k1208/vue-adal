...
var AuthenticationContext = /*#__PURE__*/function () {
  /**
...
var getToken = function getToken(resource, http, cb) {
  exports.AuthContextInstance.acquireToken(resource, function (err, token) {
    if (err) {
      ...
      switch (errCode) {
        case 'AADSTS50058':
          ...
          exports.AuthContextInstance.login();
          break;

        case 'AADSTS65001':
          // Token is invalid; grab a new one
          exports.AuthContextInstance.acquireTokenRedirect(resource);
          break;
...
var AxiosAuthHttp = /*#__PURE__*/function () {
    ...
    value: function createNewClient(options) {
      ...
      http.interceptors.response.use(function (response) {
        ...
        if (error.response.status === 401) {
          exports.AuthContextInstance.adalContext.clearCacheForResource(options.resourceId);
      ...
      options.router.beforeEach(function (to, from, next) {
        getToken(options.resourceId, http, function (err, token) {
          ...
          if (options.onTokenSuccess instanceof Function) {
            options.onTokenSuccess(http, exports.AuthContextInstance, token);
          }
...
exports.AuthContextInstance = null;
var AdalPlugin = {
  install: function install(app) {
    var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    exports.AuthContextInstance = new AuthenticationContext(opts);
    app.config.globalProperties.$adal = exports.AuthContextInstance;
  }
};
